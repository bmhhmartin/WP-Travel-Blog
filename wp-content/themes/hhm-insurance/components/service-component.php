        ...
        <div class="container py-5">
            ...
            <div class="row g-4 justify-content-center">
                ...
                <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="service-item">
                        <div class="service-img">
                            <img src="<?php echo get_template_directory_uri();?>/assets/images/blog-2.png" class="img-fluid rounded-top w-100" alt="">
                            <div class="service-icon p-3">
                ...
                <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="service-item">
                        <div class="service-img">
                            <img src="<?php echo get_template_directory_uri();?>/assets/images/blog-3.png" class="img-fluid rounded-top w-100" alt="">
                            <div class="service-icon p-3">
                ...
                <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.8s">
                    <div class="service-item">
                        <div class="service-img">
                            <img src="<?php echo get_template_directory_uri();?>/assets/images/blog-4.png" class="img-fluid rounded-top w-100" alt="">
                            <div class="service-icon p-3">
